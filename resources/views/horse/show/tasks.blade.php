    <div class="card-box">
            ...
            <div class="pt-1">
                ...
                <div class="progress progress-sm m-0">
                    <div class="progress-bar bg-purple" role="progressbar" aria-valuenow="{{dateDifferencePercent($task->task_start,$task->task_end)}}" aria-valuemin="0" aria-valuemax="100" style="width: {{dateDifferencePercent($task->task_start,$task->task_end)}}%">
