  <div class="card-box text-center">
            ...
            <div class="text-left mt-3">
                ...
                <p class="text-muted mb-2 font-13"><strong>{{__("Birth date")}}:</strong> <span class="ml-2">{{$horse->birthdate}}</span></p>

                <p class="text-muted mb-2 font-13"><strong>{{__("Gender")}} :</strong><span class="ml-2">{{$horse->gender}}</span></p>
                @if ($horse->passport_number)
                <p class="text-muted mb-2 font-13"><strong>{{__("Passport number")}} :</strong> <span class="ml-2 ">{{$horse->passport_number}}</span></p>
                @endif
                @if ($horse->FEI_number)
                <p class="text-muted mb-2 font-13"><strong>{{__("FEI number")}} :</strong> <span class="ml-2 ">{{$horse->FEI_number}}</span></p>
                @endif
