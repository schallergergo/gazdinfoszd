                    ...
                    <ul class="navbar-nav ml-auto">
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="{{route('task.index.user',Auth::user())}}">
                                        ...
                                        <div>
                                            <div class="small text-gray-500">
                                                {{$task->task_day}} : {{$task->task_start}} -{{$task->task_end}} 
                                            </div>
                                            <span class="font-weight-bold">{{$task->task}}</span>
                                        </div>
                                    </a>
                                @endforeach
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{route('message.show',$message)}}">
                                    ...
                                    <div class="font-weight-bold">
                                        ...
                                        <div class="small text-gray-500">{{$message->user->name}} · {{$message->created_at}}</div>
                                    </div>
                                </a>
                               @endforeach
